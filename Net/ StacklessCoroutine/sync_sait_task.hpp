...
#ifndef COROUTINE_DETAIL_SYNC_WAIT_TASK_H
#define COROUTINE_DETAIL_SYNC_WAIT_TASK_H

#include "detail/compilerConfig.hpp"
#include "detail/awaiter_impl.hpp"
#include "detail/lightweight_manual_reset_event.h"
